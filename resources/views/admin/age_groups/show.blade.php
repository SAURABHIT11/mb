...
@section('title', 'Age Group Details')
        ...
        <div class="col-md-8">
            ...
            <div class="card shadow border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <div class="text-muted small">Age Group Name</div>
                        <div class="fw-bold fs-5">{{ $ageGroup->name }}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <span class="badge bg-secondary">{{ $ageGroup->sort_order }}</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.age-groups.edit', $ageGroup->id) }}" class="btn btn-primary px-4">
