  ...
  <div class="container">
    <div class="hero-grid">
      ...
      <div class="hero-card">
        ...
        <p>
          Fun interactive games for math, letters, puzzles and more.
        </p>
        ...
        <form method="GET" action="{{ route('games.index') }}">
          <div class="searchbar">
            ...
            <input class="input"
                   ...
                   name="q"
                   value="{{ request('q') }}"
                   placeholder="Search games (ex: Balloon Pop, ABC, Puzzle...)">
      ...
      <div class="stats">
        <div class="stat">
          ...
          <span class="pill">Play Online</span>
        </div>
        ...
        <div class="stat">
          ...
          <span class="pill" style="background:#f0fdf4;border-color:#86efac;color:#166534;">Instant Play</span>
        </div>
        ...
        <div class="stat">
          ...
          <span class="pill" style="background:#fff7ed;border-color:#fdba74;color:#9a3412;">More Levels</span>
        </div>
      </div>
...
<section class="section">
  <div class="container">
    ...
    <div class="section-title">
      <div>
        <h2>Latest Games</h2>
        <span>Showing {{ $contents->count() }} of {{ $contents->total() }} games</span>
      </div>

      <a href="{{ route('games.index') }}" class="btn btn-soft">Reset Filters</a>
    </div>
    ...
    <div class="grid">
      @forelse($contents as $content)
        ...
        <div class="card">
          <div class="thumb">
            ...
            <img
              src="{{ $content->thumbnail ? asset('storage/'.$content->thumbnail) : 'https://via.placeholder.com/1200x800?text=Game' }}"
              alt="{{ $content->title }}">
          </div>
          ...
          <div class="card-footer">
            ...
            <a href="{{ route('content.show', $content->slug) }}"
               class="btn-card {{ $content->is_premium ? 'btn-premium' : 'btn-play' }}">
              {{ $content->is_premium ? 'Unlock & Play' : 'Play Now' }}
            </a>
      ...
      @empty
        <div style="grid-column: 1 / -1; padding:20px;">
          <div class="hero-card">
            <h3 style="font-weight:900;font-size:18px;margin-bottom:6px;">No games found 😢</h3>
