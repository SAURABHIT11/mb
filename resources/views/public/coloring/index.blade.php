...
@section('title', 'Coloring Pages - KidsNest')
...
<section class="hero">
  <div class="container">
    <div class="hero-grid">
      ...
      <div class="hero-card">
        <h1>Printable Coloring Pages 🖍️🎨</h1>
        <p>
          Cute, clean and kid-safe coloring pages. Download & print instantly.
        </p>

        <form method="GET" action="{{ route('coloring.index') }}">
          <div class="searchbar">
            ...
            <input class="input"
                   ...
                   name="q"
                   value="{{ request('q') }}"
                   placeholder="Search coloring pages (ex: Animals, Fruits, Cars...)">
      ...
      <div class="stats">
        <div class="stat">
          ...
          <span class="pill">Simple Outline</span>
        </div>
        ...
        <div class="stat">
          ...
          <span class="pill" style="background:#f0fdf4;border-color:#86efac;color:#166534;">Print Ready</span>
        </div>
        ...
        <div class="stat">
          ...
          <span class="pill" style="background:#fff7ed;border-color:#fdba74;color:#9a3412;">HD PDF</span>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="section-title">
      <div>
        ...
        <span>Showing {{ $contents->count() }} of {{ $contents->total() }} pages</span>
      </div>

      <a href="{{ route('coloring.index') }}" class="btn btn-soft">Reset Filters</a>
    </div>
    ...
    <div class="grid">
      @forelse($contents as $content)
        ...
        <div class="card">
          <div class="thumb">
            ...
            <img
              src="{{ $content->thumbnail ? asset('storage/'.$content->thumbnail) : 'https://via.placeholder.com/1200x800?text=Coloring+Page' }}"
              alt="{{ $content->title }}">
          </div>
          ...
          <div class="card-footer">
            <a href="{{ route('coloring-pages.show', $content->slug) }}" class="btn-card">
              Preview
            </a>

            <a href="{{ route('coloring-pages.show', $content->slug) }}" class="btn-card btn-download">
              Download
            </a>
          </div>
        </div>
      ...
      @empty
        <div style="grid-column: 1 / -1; padding:20px;">
          <div class="hero-card">
            <h3 style="font-weight:900;font-size:18px;margin-bottom:6px;">No coloring pages found 😢</h3>
