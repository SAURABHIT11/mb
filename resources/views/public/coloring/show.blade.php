...
<section class="page">
  ...
  @php
        ...
        <div class="side">
          ...
          @else
            <a href="{{ route('download.content', $content->id) }}" class="btn btn-primary">
              ...
              <a href="{{ route('coloring-pages.fill', $content->slug) }}" class="btn btn-danger mt-1">
             Color Online
            </a>
            <a href="{{ route('coloring.index') }}" class="btn btn-soft">
    ...
    <div class="grid">
      ...
      @php
                                    $file = $item->files->first(); // eager load files in controller
                                    $fileUrl = $file ? asset('storage/'.$file->file_path) : null;
                                  @endphp
        <a class="s-card" href="{{ route('coloring_pages.show', $item->slug) }}">
          <div class="s-thumb">
